...
InsurancePlz.ButtonBox = function(game, x, y, options) {
    ...
    var btn = game.add.button(200, 10, 'button_small', InsurancePlz.GameState.showHowToPlay, InsurancePlz.GameState);
    this.add(btn);
    ...
    btn = game.add.button(200, 60, 'button_small', InsurancePlz.GameState.askBackToMenu, InsurancePlz.GameState);
    this.add(btn);
    ...
    btn = game.add.button(20, 10, 'button_large', InsurancePlz.GameState.endTurn, InsurancePlz.GameState);
    this.add(btn);
