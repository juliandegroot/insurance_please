...
InsurancePlz.GameState.showHowToPlay = function() {
    this.popup = new Popup(["Hackers Manual - Vulnerabilities", "Hackers Manual - Attacks"], ["Companies are able to secure themselves in various ways by taking security measures: \n1. No BYOD-policy: provides strong protection against all attacks except USB-sticks.\n2. Password management: provides strong protection against most attacks, except password stealing and social engineering.\n3. Email or web security devices: provides strong protection against some attacks except Pop-ups, Phishing and Drive-by-Downloading.\n4. Auto-software-update on all devices: provides strong protection against almost every attack except drive-by-downloading and social engineering.\n5. Firewall updating: provides strong protection against almost every attack except rogue WiFi networks, Phishing and Drive-by-Downloading.\n6. Staff training (cyberaware): protects mildly against all attacks.\n7. Risk assessment & audit: protects mildly against all attacks.\n8. Technical advice on hard- and software risks: protects mildly against all attacks.\n9. Service contract (SLA) with IT-specialists: protects mildly against all attacks.", "USB Stick: Spread free USB-sticks with malicious content (malware, ransomware, virus)\nPopUp: Spread messages that 'pop up' on employees computers when they are searching the web. When they click on them, malicious content can be spread\nRogue Wi-Fi: Set-up a wireless access point, possible disguised as the companies network, that employees can connect to. This gives access to their systems.\nPhishing: Obtain sensitive information such as usernames, passwords, and credit card details by disguising as the company using emails.\nPassword stealing: Steal passwords that are written down by employees and left unattended.\nSocial Engineering: Psychologically manipulate employees into performing actions or divulging confidential information. A type of confidence trick for the purpose of information gathering, fraud, or system access.\nDrive-by-Download: Hide malicious content behind legitimate downloads, so the content is downloaded along with another file without knowledge of the employee."], 'howtoplaypanel');
